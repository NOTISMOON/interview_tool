  ...
  return (
    <div className="max-w-[700px]">
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-xl font-bold text-[#0D1117]">我的关注 ({totalCount})</h1>
      </div>
            ...
            <div key={user.id}>
              ...
              <div className="flex items-center gap-4 px-5 py-4 hover:bg-[#F6F8FA] transition-colors">
                ...
                <button
                  ...
                  className="flex-shrink-0 px-4 py-1.5 rounded-lg text-sm font-medium transition-all bg-[#F6F8FA] text-[#5F6B7A] border border-[#E1E4E8] hover:border-[#CF222E] hover:text-[#CF222E] hover:bg-[#FFF0F1]"
                >
                  已关注
                </button>
              </div>
